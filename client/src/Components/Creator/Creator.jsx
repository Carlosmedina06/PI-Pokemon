    ...
    <>
      ...
      <Grid>
        <Form isLoading={loading} onSubmit={(e) => handleSubmit(e)}>
          {loading === true ? (
            <Span isLoading={true}>Registrando datos</Span>
          ) : (
            <>
              ...
              <MiniButton type="submit" value="¡Crear PokeUser!">
                Create Pokemon
              </MiniButton>
            </>
          )}
        </Form>
        <Button isForm={true} onClick={() => history.push('/home')}>
          Home
        </Button>
      </Grid>
      <Footer />
